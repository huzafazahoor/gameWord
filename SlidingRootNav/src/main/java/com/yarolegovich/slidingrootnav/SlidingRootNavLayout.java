...
//                        outline.setRoundRect(0, 0, view.getWidth(), view.getHeight(), Math.abs(getResources().getDisplayMetrics().density*50));
//                    }
//                });
...
//                    @Override
//                    public void getOutline(View view, Outline outline) {
//                        outline.setRoundRect(0, 0, view.getWidth(), view.getHeight(), Math.abs(getResources().getDisplayMetrics().density*0));
//                    }
//                });
...
//        }
    ...
    private class ViewDragCallback extends ViewDragHelper.Callback {
        ...
        public boolean tryCaptureView(@NonNull View child, int pointerId) {
            Log.d("PointerID", String.valueOf(pointerId));
            if (isMenuLocked) {
                return false;
            }
...
//            }
        ...
        public void onViewDragStateChanged(int state) {
            if (dragState == ViewDragHelper.STATE_IDLE && state != ViewDragHelper.STATE_IDLE) {
                ...
                Log.d("RootNavLayout",String.valueOf(dragState));
